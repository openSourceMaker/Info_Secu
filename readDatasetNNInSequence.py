...
class readDatasetNNInSequence:
    ...
    def preprocessing(self):
        ...
        # aaa = np.array([x_train_input[0]])
        # print(aaa)
        # print(aaa.shape)

        self.x_train_data = np.array(x_train_input)
        ...
        self.x_test_data = np.array(x_test_input)
